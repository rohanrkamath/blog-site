...
export class ArticleController {
  ...
  @ApiOperation({
    summary: 'Checks whether the guid information has been used before in pages and articles.',
  })
  ...
  /*
   * Since this service is called server-side from NextJS, we cannot get the IP directly.
   * Therefore, we get the IP address from the query and check it.
   */
  @ApiOperation({
    summary: 'Like article item by id.',
  })
